...
def opening_hours(request):
    opeining_hours= OpeningHour.objects.filter(vendor=get_vendor(request))
    form=OpeningHourForm()
    context={
        'form':form,
        'opening_hours':opening_hours,
    }
    return render(request, 'vebdor/opening_hours.html',context)


def add_opening_hours(request):
    #handle data and save them into the database
    if request.user.is_authenticated:
